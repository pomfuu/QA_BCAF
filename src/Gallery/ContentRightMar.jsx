...
const ContentRightMar = ({ selectedMonth }) => {
        ...
        <div className='container-fluid'>
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div style={{ backgroundColor: '#00BDB2' }} className="text-white font2 rounded-2 px-4 py-1">MARCH ACHIEVEMENTS</div>
                    <div className='mt-2'>
                        <Table size='sm' hover>
...
export default ContentRightMar;
