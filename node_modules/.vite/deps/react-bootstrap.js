...
<<<<<<< Updated upstream
  Table_default
} from "./chunk-65AZLEBD.js";
import {
  DropdownButton_default
} from "./chunk-CBHCVJ5M.js";
=======
  DropdownButton_default
} from "./chunk-LBAGX4UT.js";
>>>>>>> Stashed changes
import {
  ...
  useWindow
<<<<<<< Updated upstream
} from "./chunk-M6PD5DV5.js";
=======
} from "./chunk-Q5GVPS5W.js";
import {
  Table_default
} from "./chunk-GI6EKYX5.js";
>>>>>>> Stashed changes
import {
  DEFAULT_BREAKPOINTS,
...
import {
  require_prop_types
} from "./chunk-SJ6NEQIP.js";
=======
} from "./chunk-3UTQPYKA.js";
import "./chunk-WMYJ4TDZ.js";
>>>>>>> Stashed changes
import {
  require_react_dom
...
var Switch = React58.forwardRef((props, ref) => (0, import_jsx_runtime56.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react30.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react30.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react31.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime67.jsx)("div", Object.assign({}, dialogProps, {
    children: React69.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalContext = React71.createContext({
...
var AbstractModalHeader = React74.forwardRef(({
  ...
  const context4 = (0, import_react32.useContext)(ModalContext_default);
...
var Modal2 = React77.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react33.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react33.useState)(false);
  const waitingForMouseUpRef = (0, import_react33.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react33.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react33.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react33.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react33.useCallback)((backdropProps) => (0, import_jsx_runtime77.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React78.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav2 = React80.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react34.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react34.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react37.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react38.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasTitle = React87.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React88.forwardRef(({
  ...
  const modalManager = (0, import_react39.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react39.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react39.useState)(false);
  ...
  const renderBackdrop = (0, import_react39.useCallback)((backdropProps) => (0, import_jsx_runtime88.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React89.forwardRef((props, ref) => {
  const context4 = (0, import_react40.useContext)(NavbarContext_default);
...
var Navbar = React91.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react41.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react41.useMemo)(() => ({
...
var NavDropdown = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames73.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime94.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime94.jsx)(Dropdown_default.Menu, {
      role: menuRole,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime105.jsxs)(import_jsx_runtime104.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react46.cloneElement)(children, triggerProps), (0, import_jsx_runtime103.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var SplitButton = React109.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime116.jsxs)(Dropdown_default, {
  ref,
  ...props,
  ...
  children: [(0, import_jsx_runtime115.jsx)(Button_default2, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime115.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime115.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react48.useContext)(TabContext_default);
  if (!context4)
...
var ToastFade = React117.forwardRef((props, ref) => (0, import_jsx_runtime125.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React119.forwardRef(({
  ...
  const context4 = (0, import_react50.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
